...
| **Libelle** | Capture chip acknowledges in the firmware for per-chip faults (Libelle_Driver_ShortWave //FIX!); confirm Libelle_Driver_ShortWave is the deployed firmware file; bench | Library on NW_Core 2026-09-23; capacity default 8 per group (a proposal: ten fields, two units per logger) |

...
<!-- nw_status:begin -->
# NorthernWidget device and library status — 2026-09-20
...
|---|---|---|---|---|---|---|---|---|---|---|
| **Devices** | | | | | | | | | | |
| **Apis** | Sensor | Apis_Library | NorthernWidget/Apis_Library | Project-Apis | NorthernWidget/Project-Apis | ✅ | 3 | ✅ 0 | 15 | ◐ 5 |
...
| **Okapi** | Logger | Okapi_Library | NorthernWidget-Skunkworks/Okapi_Library | Project-Okapi | NorthernWidget-Skunkworks/Project-Okapi | ❌ no | 8 | ✅ 0 | 21 | ◐ 1 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| **Devices** | | | | | | | | | | | | | | | | | | | |
| **Apis** | 0.1.0 | v0.1.0 | ✅ | v0.1.1 | 4 | ✅ | ✅ | ✅ | ✅ Sensors | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | Apis_Demo, Margay | ✅ |
| **Haar** | 1.0.0 | v1.0.0 | ✅ | v0.1.1 | 8 | ✅ | ✅ | ✅ | ✅ Sensors | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | Haar_Demo, SerialDemo | ✅ |
| **Walrus** | 0.2.0 | v0.2.0 | ✅ | v0.3.0 | 12 | ✅ | ✅ | ✅ | ✅ Sensors | ✅ | ✅ | ✅ | ✅ | ❌ MISSING | ✅ | ✅ | ❌ MISSING | none | ❌ MISSING |
| **Libelle** | 1.0.0 | v1.0.0 | ✅ | v0.1.1 | 24 | ✅ | ✅ | ✅ | ✅ Sensors | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | LibelleMargayDemo, LibelleSWDemo, Libelle_Demo | ✅ |
| **Liasis** | 1.0.0 | v1.0.0 | ✅ | v0.1.1 | 5 | ✅ | ✅ | ✅ | ✅ Sensors | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | Liasis_Demo | ✅ |
| **Margay** | 1.2.0 | v1.2.0 | ✅ | v2.2.2 | 93 | ✅ | ✅ | ✅ | ✅ Data Storage | ✅ | ❌ latestdoi (deprecated) | ✅ | ❌ MISSING | ✅ | ✅ | ✅ | ❌ MISSING | Basic, HighSpeed_NoSleep, Laser_Ranging, SensorDemo_TP-Downhole | ✅ |
| **Okapi** | 0.7.0 | v0.6.0 | ❌ NO (v0.6.0 vs 0.7.0) | v0.6.0 | 3 | ✅ | ✅ | ✅ | ✅ Data Storage | ✅ | ✅ | ✅ | ✅ | ✅ | ◐ named doxygen_Okapi.cfg | ✅ | ✅ | Okapi_Demo | ✅ |
...
|---|---|---|---|---|
| **Apis** | ✅ | ❌ MISSING (2019 prototype map: status at 0x00; address register at 0x0C) | ❌ MISSING (reads 2019 register map) | ❌ no |
...
| **Apis** | v0.1.1 | 4 | 3 | 0 | — | 1 |
| **Haar** | v0.1.1 | 8 | 2 | 0 | — | 0 |
| **Walrus** | v0.3.0 | 12 | 3 | 0 | — | 2 |
| **Libelle** | v0.1.1 | 24 | 2 | 0 | — | 3 |
| **Liasis** | v0.1.1 | 5 | 1 | 0 | — | 0 |
| **Margay** | v2.2.2 | 93 | 1 | 1 | ❌ no (KiCad 7 import; BoM fields populated; not netlist-compared) | 7 |
| **Okapi** | v0.6.0 | 3 | 3 | 2 | ❌ no (KiCad 10 import; power nets and no-connects fixed; not netlist-compared) | 13 |
| **Tally** | v0.1 | 39 | 3 | 0 | — | 1 |
...
|---|---|---|
| **Devices** | | |
| **Apis** | Firmware Page 0/1 rewrite; then library |  |
...
| **Okapi** | Triage June review issues toward a buildable board -> ERC/DRC -> Gerbers -> v1.0 tag -> order | 5 library bugs filed 2026-06-02 (#3-#7); snapshot tag waits on hardware test · Prototype; current design is untagged Eagle v1.0 updates (2024-11-02) with CAM outputs |
...
| **T9602_Library** | Fix version= and url=; keywords.txt; .zenodo.json; docs.yml; example; bool begin() | tag v1.0.0 (2022) exists while library.properties says 0.0.0 |

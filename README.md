...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| **Devices** | | | | | | | | | | | | |
| **Apis** | Sensor | Apis_Library | NorthernWidget/Apis_Library | Project-Apis | NorthernWidget/Project-Apis | ✅ | 3 | ✅ 0 | ◐ 14 | 16 | ◐ 5 | ◐ 7 |
...
| **Margay** | Logger | Margay_Library | NorthernWidget/Margay_Library | Project-Margay | NorthernWidget/Project-Margay | ❌ no | 13 | ✅ 0 | ◐ 1 | 19 | ◐ 2 | ◐ 1 |
| **Okapi** | Logger | Okapi_Library | NorthernWidget-Skunkworks/Okapi_Library | Project-Okapi | NorthernWidget-Skunkworks/Project-Okapi | ❌ no | 8 | ✅ 0 | ✅ 0 | 22 | ◐ 1 | ✅ 0 |
...
| **T9602_Library** | Sensor | T9602_Library | NorthernWidget-Skunkworks/T9602_Library | — | — | ❌ no | 1 | ◐ 1 | ✅ 0 | — | — | — |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| **Devices** | | | | | | | | | | | | | | | | | | | |
| **Apis** | 0.1.0 | v0.1.0 | ✅ | v0.1.1 | 12 | ✅ | ✅ | ✅ | ✅ Sensors | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | Apis_Demo, Apis_Readings, Margay | ✅ |
...
|---|---|---|
| **Devices** | | |
| **Apis** | Bench test firmware patch 1 + library on a provisioned board; then revisit how Apis runs (Andy's priority); Project-Apis #22 accelFail bug |  |

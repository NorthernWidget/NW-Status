...
"""
import csv, datetime, json, re, subprocess, sys, urllib.request
...
def icon(col, v):
    ...
    if v.startswith(("MISSING", "NO", "no ", "no", "PascalCase", "blank", "WRONG", "latestdoi", "flat")): return "❌"
    return "◐"
...
INTRO = """# NorthernWidget device and library status — {date}

...
LIB_COLS = ["Library", "Type", "Device", "GitHub", "version=", "Last tag", "version = tag",
            ...
            "moxygen remnants", ".doxybook config", "_docs/ site config", "README API link",
...
GROUPS = [
    ...
    ("Docs conversion",  ["docs.yml", ".doxybook config", "_docs/ site config", "moxygen remnants", "README API link"]),
